 ...
 */
package de.hybris.b2c.cockpits.setup;
...
import de.hybris.b2c.cockpits.constants.B2cCockpitsConstants;
 ...
 */
@SystemSetup(extension = B2cCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(B2cCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(B2cCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						B2cCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/b2ccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
