 ...
 */
package de.hybris.b2c.test.setup;
...
import de.hybris.b2c.test.constants.B2cTestConstants;
import de.hybris.b2c.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = B2cTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/b2ctest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/b2ctest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/b2ctest/import/cstickets.impex");
			...
			importImpexFile(context, "/b2ctest/import/csquotes.impex");
		}
	}
}
