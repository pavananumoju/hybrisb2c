 ...
 */
package de.hybris.b2c.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(B2cFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(B2cFulfilmentProcessConstants.PARENT_PROCESS);
