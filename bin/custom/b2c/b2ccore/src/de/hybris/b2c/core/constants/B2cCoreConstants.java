 ...
 */
package de.hybris.b2c.core.constants;

/**
 * Global class for all B2cCore constants. You can add global constants for your extension into this class.
 */
public final class B2cCoreConstants extends GeneratedB2cCoreConstants
{
	public static final String EXTENSIONNAME = "b2ccore";


	private B2cCoreConstants()
	{
		//empty
	}
