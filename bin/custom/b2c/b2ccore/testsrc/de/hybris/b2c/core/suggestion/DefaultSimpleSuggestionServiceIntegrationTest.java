 ...
 */
package de.hybris.b2c.core.suggestion;
...
import de.hybris.b2c.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/b2ccore/test/testSimpleSuggestionService.csv", "utf-8");
	}
